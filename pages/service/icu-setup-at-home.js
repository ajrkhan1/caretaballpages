...
export default function ICUSetupatHome() {
    ...
    return (
        <>
            <Head>
                <title>ICU Setup at Home | Critical Care Services at Your Doorstep | CareTAB.ai</title>
                <meta name="description" content="CareTAB.ai provides complete ICU setup at home for critically ill patients. Our expert critical care team installs ventilators, monitors & life-support equipment with 24/7 nursing support." />
                                ...
                                <div className="col-md-12 col-lg-5">
                                    <div className="hero-content">
                                        ...
                                        <h6 className="hero-sub-title wow fadeInUp" data-delay=".25s">
                                            <i><img className="brandiconw" src="/assets/img/icon/brandicon.png" alt="" /></i>ICU Setup</h6> */}

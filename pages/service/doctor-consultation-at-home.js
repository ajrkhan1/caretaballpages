...
export default function DoctorConsultationatHome() {
    ...
    return (
        <>
            <Head>
                <title>Doctor Consultation at Home | Experienced Physicians Home Visit | CareTAB.ai</title>
                <meta name="description" content="Book a qualified doctor consultation at home with CareTAB.ai. Our experienced physicians visit your doorstep for diagnosis, prescription, and chronic disease management. Available across India." />
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-icon servicesl">
                                                            ...
                                                            <select class="form-control" name="service" id="service" className="service" required>                                                                
                                                                ...
                                                                <option value="Doctor Consultation at Home" selected>Doctor Consultation at Home</option>
                         ...
                         <div className="col-sm-6">
                            ...
                            {/* <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                                ...
                                <div class="blog-item-info">
                                    <div class="blog-item-meta">
                                        <h4 class="blog-title">
                                            <a href="#">24/7 Emergency Consultations</a>
                                        </h4>
                                    </div>
                                    <p>

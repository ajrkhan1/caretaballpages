                            ...
                            <div class="video-info wow fadeInUp" data-wow-delay=".25s">
                                <div class="site-heading mb-0">
                                    ...
                                    <p className="text-justify">
                                        Healthcare at home often requires the right tools. At CareTAB.ai, we make it easy to rent or buy high-quality medical equipment, ensuring that patients receive safe and seamless care without the stress of hospital dependency. Whether it’s short-term recovery support or long-term use, we’ve got you covered.
                                    </p>
                                </div>
                ...
                <div class="feature-wrapper">
                    <div class="row g-4 slpadding">
                        <div className="col-sm-12">
                            <div class="site-heading mb-0">
                                    <h2 class="site-title">How To Buy/Rent Medical Equipment at <span> CareTAB.ai?</span></h2>
                                </div>
                        </div>                     
                        <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 whycaretb pt-50 pb-50">
                            <div class="video-info wow fadeInUp insidep" data-wow-delay=".25s">
                                <div class="site-heading mb-0">
                                    <h2 class="site-title">Why Choose CareTAB.ai <br></br><span>Equipment Services?</span></h2>                                  
                                </div>
                                <div class="feature-content">                                        
                                        <ul class="listicon">
                                            <li>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                       Yes. CareTAB.ai offers flexible rental plans for patients who need equipment for short durations such as post-surgery recovery or temporary rehabilitation.
                                    </div>
                                </div>
                            </div>
